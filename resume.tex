...
\begin{body}
  ...
  \textbf{Internship (part-time)}, {Build a GPU Computing Research Cluster} \hfill \emph{Jul 2015}\\
  \vspace*{-4pt}
  \begin{itemize} \itemsep -0pt  \small
  \item Attached to Rapid-Rich Object Search Lab
  \item Used Rocks Cluster Distribution
  \item Configed Head-node and Compute-node network connections
  \item Analyzed and proposed possible solutions to user management and resources control
