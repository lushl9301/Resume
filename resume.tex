...
\begin{body}
  ...
  \item Analyzed user management and resources control requirements and proposed possible solutions
  \item Used Docker and composed Dockerfile for Cuda GPU computing
...
\begin{body}
  ...
  \item Used Verilog to implement a five-stage pipelined CPU with MIPS instruction set under simulation
    \begin{itemize} \itemsep -0pt \small
        \item With hazard detection \& data forwarding
  ...
  \item Designed and constructed a blood pulse wave data acquisition system
    \begin{itemize} \itemsep -0pt \small
        ...
        \item MATLAB for post processing \& graphic display
    \end{itemize}
  \end{itemize}
\end{body}
