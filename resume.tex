...
\begin{body}
  ...
  \textbf{Internship}, {Build a GPU Computing Research Cluster} \hfill \emph{Jul 2015}\\
  \vspace*{-4pt}
  \begin{itemize} \itemsep -0pt  \small
  \item Attached to Rapid-Rich Object Search Lab
  \item Used Rocks cluster distribution
  \item Configured Head-node and Compute-node network connections
  \item Provided solutions for user management and resources control
  \item Used Docker for Cuda GPU computing
  \item Used LXC (cgroups) for resources provision and control
  \item Supervised by Mr. Yin Jianxiong
  \end{itemize}
  ...
  \vspace*{-4pt}
  \begin{itemize} \itemsep -0pt  \small
  \item Attached to Neural \& Biomedical Technology Department (A*star $I^{2}R$)
...
\begin{body}
  ...
  \item Built a robotic system that can autonomously explore and traverse unknown areas (in a team of eight)
    ...
    \end{itemize}
  \item Implemented a five-stage pipelined CPU with MIPS instruction set under simulation in Verilog
    \begin{itemize} \itemsep -0pt \small
...
\begin{body}
  \vspace{14pt}
  \textbf{Vice President}, NTU CAC, Dragon \& Lion Dance Troupe \hfill {} \emph{Aug 2013 - 14}\\
  \smallskip
...
\begin{body}
  ...
  \medskip
  \textbf{Applications:}{} Git, Make, Emacs, Vim, \LaTeX, Docker\\
  \medskip
